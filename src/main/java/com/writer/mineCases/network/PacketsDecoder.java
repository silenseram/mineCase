...
import com.writer.mineCases.pojo.Case;
...
public class PacketsDecoder {
    ...
    public static List<Case> getCases() {
        ...
        //cases.add(new Case("���� �������", 228, "http://cs414419.vk.me/u10069748/docs/5fa7f5dc38f6/Case.png"));
        //cases.add(new Case("��� ��������", 1488, "http://cs404426.vk.me/u10069748/docs/1b9ea2780611/CaseLol.png"));
