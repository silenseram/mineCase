...
import com.writer.mineCases.ColorHelper;
import com.writer.mineCases.Refs;
import com.writer.mineCases.Strings;
import com.writer.mineCases.model.ModelGuiCase;
import com.writer.mineCases.network.PacketsDecoder;
import com.writer.mineCases.network.Recieve;
import com.writer.mineCases.pojo.CaseItem;
...
public class GuiCaseView extends MPGui {
    ...
    public void drawScreen(int x, int y, float ticks) {
        ...
        ScaledResolution scaled = new ScaledResolution(mc); //TODO
        ...
        if (!Recieve.isRolling) {
            ...
            if (!isCaseLoading) {
                ...
                if (isClicked(guiX + 65, guiY + 39, 125, 14)) {
                    //isRolling = true;
                    isCaseLoading = true;
                    mc.player.sendChatMessage("/rollcase " + caseid);
    ...
    private void drawWonScreen(int x, int y, float ticks) {
        ...
        drawCenteredString(fontRenderer, itemStack.getDisplayName() , width / 2, guiY - 12, 0xFFFFFF);
        ...
        is.setCount(1);
        EntityItem entityItem = new EntityItem(mc.world, 0D, 0D, 0D, is);
        ...
        if (numAnim >= 0.22) {
            ...
            fontRenderer.drawString(TextFormatting.DARK_GRAY + "" + itemsCount, 0, 0, 0xCC000000);
            GL11.glPopMatrix();
        }
