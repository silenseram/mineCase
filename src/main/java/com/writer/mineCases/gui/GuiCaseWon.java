...
import com.writer.mineCases.model.ModelGuiCase;
...
public class GuiCaseWon extends MPGui {
    ...
    public void drawScreen(int x, int y, float ticks) {
        ...
        //drawCenteredString(fontRendererObj, itemStack.getDisplayName() , width / 2, guiY - 12, 0xFFFFFF); БЫЛО
        drawCenteredString(fontRenderer, itemStack.getDisplayName() , width / 2, guiY - 12, 0xFFFFFF); //сделал рекер в 2020
        ...
        GL11.glPushMatrix();
       // EntityItem entityItem = new EntityItem(mc.theWorld, 0D, 0D, 0D, itemStack); БЫЛО
        EntityItem entityItem = new EntityItem(mc.world, 0D, 0D, 0D, itemStack); // сделал рекер в 2020
        ...
        if (numAnim >= 0.22) {
            ...
            //fontRendererObj.drawString(EnumChatFormatting.DARK_GRAY + "" + itemsCount, 0, 0, 0xCC000000); БЫЛО
            fontRenderer.drawString(TextFormatting.DARK_GRAY + "" + itemsCount, 0, 0, 0xCC000000); //TODO
            GL11.glPopMatrix();
        }
